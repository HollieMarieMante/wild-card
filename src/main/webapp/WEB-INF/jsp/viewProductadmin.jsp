...
<body class="flex flex-col">
        ...
        <div class="profile-container">
            ...
            <div class="profile-picture">
                ...
                <div class="buttons-container">
                    <button class="btn btn-secondary" onclick="updateStatus('${product.productId}', 1)">Approved</button>
    <button class="btn btn-primary" onclick="updateStatus('${product.productId}', 0)">Disapproved</button>
                </div>
            </div>
        </div>
    </div>
    ...
    //tochange Status approved/disapproved
    function updateStatus(productId, status) {
    // Make an AJAX request to update the status
    fetch('/products/${product.productId}/status', {
