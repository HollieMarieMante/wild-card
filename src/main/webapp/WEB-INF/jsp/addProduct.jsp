        ...
        <div class="h-20 w-full">
            <div class="bg-[#AD4646] w-full flex justify-between items-center h-full px-10">
                <details class="dropdown">
                    <summary class="btn w-64 m-1 bg-transparent hover:bg-transparent border-none hover:border-none shadow-none flex items-center justify-start cursor-pointer">
